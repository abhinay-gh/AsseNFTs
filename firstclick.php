	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form">
				<div class="wrap-input100 validate-input" data-validate="NFT tokenId is required">
					<span class="label-input100"> Asset TokenId: </span>
					<input class="input100" type="text" id="nfttokenid" placeholder="Enter your asset tokenid">
